...
<head>
  ...
  <link rel="stylesheet" href="/hzaueqt3/hzaueqt3/Public/Css/bootstrap.css"/>
    ...
    <div class="container">
      ...
      <div id="main_nav">
        <section>
          <h3>通知</h3>
          <ul class="ultop">
            <li><a href="#" style="border-left: 3px solid orange;">通知公告</a></li>
          </ul>
        </section>
      </div>
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaueqt3/hzaueqt3/index.php/home/Index/index.html">首页</a> · <a href="#">中心概况</a> · <a href="#">通知公告</a> · <a href="#"><?php echo ($data["inforname"]); ?></a></nav>
        <header class="main_title"><h2><?php echo ($data["inforname"]); ?></h2></header>
        <section class="article">
          <p class="contantdis">
            <?php echo ($data["inforcnt"]); ?>
          </p>
        </section>
      </div>
    </div>
