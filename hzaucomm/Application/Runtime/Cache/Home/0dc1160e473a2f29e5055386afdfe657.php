...
<head>
	...
	<link rel="stylesheet" href="/hzau/hzaucomm/Public/face/css/comp.css"/>
	...
	<div id="Cmain">
		<div class="Ccontainer">
			...
			<section>
				<h3>综合交流</h3>
				<ul class="ultop">
					<li><a href="/hzau/hzaucomm/index.php/Home/comp/comp2">最近主题</a></li>
					<li><a href="/hzau/hzaucomm/index.php/Home/comp/comp1">热门主题</a></li>
				</ul>
			</section>
			</div>
			<?php if(($_SESSION['username']) == ""): ?><p>您还未登录</p>
				<?php echo md5(12151618); ?>
				<?php else: ?>
					<p>欢迎您：<?php echo (session('username')); ?></p><?php endif; ?>
			<div class="rightc">
    <div id="topicCon">
        <div class="mini_nav">
            <span class="mini_title">课程</span>
            <a href="/hzau/hzaucomm/index.php/Home/Comp/themeluanch"><button class="button">发表新主题</button></a>
        </div>
        <div>
            <?php if(is_array($theThemes)): $i = 0; $__LIST__ = $theThemes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?><div class="topic">
                    <div class="substance">
                        <div class="substance_top">
                            <div class="s_t_title"><a href="/hzau/hzaucomm/index.php/Home/course/showitem/id/<?php echo ($items["id"]); ?>">讨论交流主题 <?php echo ($items["msname"]); ?></a></div>
                            <div class="author">
                                <span  class="s_t_l"><img  src="/hzau/hzaucomm/Public/face/images/icon/person.png" alt="" class="icon_a" title="主题作者" ) no-repeat;"><?php echo ($items["msowner"]); ?></span>
                                <span  class="s_t_l"><img  src="/hzau/hzaucomm/Public/face/images/icon/time.png" alt="" class="icon_a" title="发布时间" ) no-repeat;"><?php echo ($items["msdate"]); ?></span>
                                <span  class="s_t_l"><img  src="/hzau/hzaucomm/Public/face/images/icon/comment.png" alt="" class="icon_a" title="评论量" ) no-repeat;"><?php echo ($items["mshaving"]); ?></span>
                                <span  class="s_t_l"><img  src="/hzau/hzaucomm/Public/face/images/icon/prise.png" alt="" class="icon_a" title="评论量" ) no-repeat;"><?php echo ($items["mslike"]); ?></span>
                            </div>
                        </div>
                        <div class="clr"></div>
                        <div class="substance_down">
                            ...
                            <div class="replyer">
                                <span class="s_d_l"><img src="/hzau/hzaucomm/Public/face/images/icon/person.png" alt="" class="icon_r" title="最新回复人" ) no-repeat;">朱传波</span>
                                <span class="s_d_l"><img src="/hzau/hzaucomm/Public/face/images/icon/time.png" alt="" class="icon_r" title="回复时间" ) no-repeat;">17：01</span>
