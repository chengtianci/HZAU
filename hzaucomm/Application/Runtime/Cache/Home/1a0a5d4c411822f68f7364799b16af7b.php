	...
	<div id="Cmain">
		<div class="Ccontainer">
			...
			<!--<div class="rightc">-->
				<!--<div id="topicCon">-->
					<!--<div class="mini_nav">-->
						<!--<span class="mini_title">关注主题</span>-->
					<!--</div>-->
					<!---->
				<!--</div>-->
			<!--</div>-->
						...
						<?php if(is_array($checkedMs)): $i = 0; $__LIST__ = $checkedMs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?><div class="topic">
								<div class="substance">
									<div class="substance_top">
										...
										<div class="author">
											<span  class="s_t_l"><img  src="/hzaucomm/Public/face/images/icon/person.png" alt="" class="icon_a" title="主题作者" ) no-repeat;"><?php echo ($items["msowner"]); ?></span>
