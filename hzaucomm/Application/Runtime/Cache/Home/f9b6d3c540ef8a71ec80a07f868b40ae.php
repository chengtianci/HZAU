...
<head>
	...
	<link rel="stylesheet" href="/hzaucomm/Public/Css/bootstrap.css"/>
	<!-- <link rel="stylesheet" href="/hzaucomm/Public/Css/bootstrap.min.css"/> -->
</head>
<body>
	<div id="Cheader">
		...
		<div class="Ccontainer">
			...
			<div class="rightc_nhot">
				...
				<div class="search_Button">
					<form class="searchform" action="/hzaucomm/index.php/Home/Source/search/type/2" method="post">
				...
				<div class="float_lis">
					<div class="list">
						<ul>
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?><li ><a class="ex_item" href="/hzaucomm/index.php/Home/source/summary/id/<?php echo ($items["id"]); ?>/cid/1"><div class="point"></div><?php echo ($items["rsname"]); ?><span><?php echo ($items["rsdate"]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
