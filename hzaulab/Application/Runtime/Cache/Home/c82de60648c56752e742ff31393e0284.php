    ...
    <div class="container">
      ...
      <div id="main_right">
        ...
        <section class="main_list">
          <ul class="show_list">
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/hzaulab/<?php echo ($vo["rsway"]); ?>"><?php echo ($vo["rsname"]); ?></a><span><?php echo ($vo["rsdate"]); ?></span></li>
            <!-- <li><a href="/hzaulab/index.php/Home/Fictitious/fictitious_show1_article"><?php echo ($vo["rsname"]); ?></a><span><?php echo ($vo["rsdate"]); ?></span></li> --><?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
          <div>
