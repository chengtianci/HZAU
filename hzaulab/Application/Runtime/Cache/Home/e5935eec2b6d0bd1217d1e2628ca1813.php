...
<div id="RegisterBox">
  ...
  <div id="main">
    <div class="container">
      ...
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">规章制度</a> · <a href="#"><?php echo ($theRecord["rsname"]); ?></a></nav>
...
<!--         <section class="article">这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题这写标题</section> -->
        <header class="main_title"> 
          <h2><?php echo ($theRecord["rsname"]); ?></h2>
        </header> 
        <section class="article">
          <div class="summary" style="width: 100%; height: 900px">
            <iframe src="/hzaulab/<?php echo ($theRealWay); ?>" style="width: 100%; height:900px;" scroll="auto" frameborder="0"></iframe>
