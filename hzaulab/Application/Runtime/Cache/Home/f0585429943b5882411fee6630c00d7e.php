...
<div id="RegisterBox">
  ...
  <div id="main">
    <div class="container">
      ...
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">实验室</a> · <a href="#"><?php echo ($basic["ecname"]); ?></a> </nav>
        <header class="main_title"><h2><?php echo ($basic["ecname"]); ?></h2></header>
        <section class="article">
          <div class="art_left">  
              ...
              <?php switch($basic['eqclass']) { case 1: $hahaha = "公共实验室"; break; case 2: $hahaha = "教学实验室"; break; case 3: $hahaha = "实验辅助室"; break; } echo $hahaha; ?>
<!--                 <select name="" id="">
              ...
              <span>面积：</span><div class="eqtcon"><?php echo ($basic["eprice"]); ?></div>
          ...
          <div class="art_right">
            <img src="/hzaulab/Uploads<?php echo ($vo["imagicaddress"]); ?>" alt="无图片" />
          </div>
          <div class="art_bottom">
            <a href="/hzaulab/index.php/Home/Laboratory/laboratory_apply/id/<?php echo ($basic["id"]); ?>"><button>现在预约</button></a>
