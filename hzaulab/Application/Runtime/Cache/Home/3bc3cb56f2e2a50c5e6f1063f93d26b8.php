...
<div id="RegisterBox">
  ...
  <div id="main">
    <div class="container">
      ...
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">仪器设备</a> · <a >设备详细</a> </nav>
        ...
        <section class="article">
          <div class="art_left">  
              ...
              <span>型号/单位：</span><div class="eqtcon"><?php echo ($basic["etype"]); ?></div>
              <!-- <select name="" id="">
                <option value ="农田土地">农田土地</option>
                <option value ="露天盆栽场">露天盆栽场</option>
                <option value="晾晒地">晾晒地</option>  
              </select><br> -->
              <span>生产商：</span><div class="eqtcon"><?php echo ($basic["ecmanufactor"]); ?></div>
              <span>设备编号：</span><div class="eqtcon"><?php echo ($basic["eid"]); ?></div>
              <span>存放地：</span><div class="eqtcon"><?php echo ($basic["elocation"]); ?></div>
              <span>设备总值：</span><div class="eqtcon"><?php echo ($basic["eprice"]); ?></div>
              <span>收费标准：</span><div class="eqtcon"><?php echo ($other["sfbz"]); ?></div>
              ...
              <span>技术指标：</span><div class="eqtcon3"><?php echo ($other["jszb"]); ?></div>
              <span>主要功能：</span><div class="eqtcon3"><?php echo ($other["zygn"]); ?></div>
              <span>应用范围：</span><div class="eqtcon3"><?php echo ($other["yyfw"]); ?></div>
              <span>主要附件：</span><div class="eqtcon3"><?php echo ($other["zyfj"]); ?></div>
              <span>使用方向：</span><div class="eqtcon3"><?php echo ($other["syfx"]); ?></div><hr>
              <h3 class="head">备注说明</h3><div class="eqtcon2"><?php echo ($basic["introduction"]); ?></div>
           
          <div class="art_right">
            <img src="/hzaulab/Public/face/images/eqt/4.jpg" style="width: 150px; height: 100px" alt="无图片" />
          </div>
          <div class="art_bottom">
            <a href="/hzaulab/index.php/Home/Equipment/equipment_show1_apply/id/<?php echo ($basic["id"]); ?>"><button>现在预约</button></a>
          </div>
        </section>
      </div>
    </div>
