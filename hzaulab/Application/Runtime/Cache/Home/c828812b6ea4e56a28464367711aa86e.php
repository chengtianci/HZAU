    ...
    <div class="container">
      ...
      <div id="main_nav">
        <section>
          <h3>实验室</h3>
          <ul class="ultop">
            <li><a href="/hzaulab/index.php/Home/Laboratory/laboratory_show1" id="thetitleha1">公共实验室</a></li>
            <li><a href="/hzaulab/index.php/Home/Laboratory/laboratory_show2" id="thetitleha2">教学实验室</a></li>
            <li><a href="/hzaulab/index.php/Home/Laboratory/laboratory_show3" id="thetitleha3">实验辅助室</a></li>
          </ul>
        </section>
      </div>
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">实验室</a> · <a href="#"><?php echo ($thetitle); ?></a> </nav>
        ...
        <section class="article">
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?><div class="pitbox">
              <h4><a href="/hzaulab/index.php/Home/Laboratory/laboratory_show1_article/id/<?php echo ($items["id"]); ?>" ><?php echo ($items["ecname"]); ?></a></h4>
              <div class="pitexplan">
                <a href="/hzaulab/index.php/Home/Laboratory/laboratory_show1_article/id/<?php echo ($items["id"]); ?>" ><img src="/hzaulab/Uploads<?php echo ($vo["imagicaddress"]); ?>" alt="无图片" /></a>
              </div>
