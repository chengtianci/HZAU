...
<head>
  ...
  <link rel="stylesheet" href="/hzau/hzaulab/Public/face/css/field_show2.css" />
    ...
    <div class="container">
      ...
      <div id="main_nav">
        <section>
          <h3>大田设施</h3>
          <ul class="ultop">
            <li><a href="/hzau/hzaulab/index.php/Home/Field/field_show1" >农田土地</a></li>
            <li><a href="/hzau/hzaulab/index.php/Home/Field/field_show2" style="border-left: 3px solid orange;">露天盆栽场</a></li>
          </ul>
        </section>
      </div>
      <div id="main_right">
        <nav class="top_nav"><a href="/hzau/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">露天盆栽场</a> · <a href="#">农田土地</a> </nav>
            ...
            <div class="planform">
              <div class="planheader">
                <form action="/hzau/hzaulab/index.php/Home/Search/searchOneday" method="post">
                  ...
                  <input class="tcal tcalInput tcalActive input" name="date" value="<?php echo ($nowDate); ?>" type="date">
                  <input type="text" name="theType" value="Pz" hidden>
                  <input type="text" name="theTypeLog" value="Log" hidden>
              ...
              <div class="planbody">
                ...
                <div id="applyform">
                  ...
                  <form class="sqbg" id="sqbg" action="/hzau/hzaulab/index.php/Home/Field/doApplication" method=post>
                    <div class="down">
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <a href=""><button type="submit" onclick="fun1()">提交</button></a>
              ...
              <div class="plat_comment" style="height: 100px;">
                  <?php echo ($theSomethingData["thecontent"]); ?>
              </div>
...
<!-- <button type="button" onclick="fun2()">导出Word</button> -->
    ...
    for (value in data) {
      ...
      if (data[value]['status'] == 2) {
        ...
        // console.log(openPot.title);
          ...
          allItems = document.getElementsByClassName(openPot.className);
          theChildItems = allItems.item(0);
          var b = theChildItems.getElementsByTagName("test");
  ...
  <script type="text/javascript">
    ...
    function fun2() {
      ...
      $.ajax({  
        type: "POST",  
        url: "/hzau/hzaulab/index.php/Home/Field/doWord", //orderModifyStatus  
        data: {
          "hahaha": data,
        }, 
        dataType:"json",  
