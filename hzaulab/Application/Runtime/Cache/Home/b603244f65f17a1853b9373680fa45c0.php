...
<head>
  ...
  <link rel="stylesheet" href="/hzau/hzaulab/Public/face/css/room_show1_one.css" />
    ...
    <div class="container">
      ...
      <div id="main_nav">
        <section>
          <h3>培养室</h3>
          <ul class="ultop">
            <li><a href="/hzau/hzaulab/index.php/Home/Room/room_show1" style="border-left: 3px solid orange;">温网室</a></li>
            <li><a href="/hzau/hzaulab/index.php/Home/Room/room_show2">光照培养室</a></li>
          </ul>
        </section>
      </div>
      <div id="main_right">
        <nav class="top_nav"><a href="/hzau/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">培养室</a> · <a href="#">温网室</a> </nav>
        <section class="article">
          <header class="main_title"><h2>温网室</h2></header>
          <div class="planform_box">
            <ul class="small_nav">
              <li><a class="now_on" href="/hzau/hzaulab/index.php/Home/Room/room_show1">山南温网室群</a></li>
              <li><a href="/hzau/hzaulab/index.php/Home/Room/room_show1_two">山北温室群</a></li>
            </ul>
            <div class="clr"></div>
            <div class="planform">
              ...
              <div class="planbody">
                <form class="planbodyform">
                  ...
                  <div class="clr"></div>
                  <div id="applyform">
                  <form class="sqbg" id="sqbg" action="/hzau/hzaulab/index.php/Home/Room/doApplication" method=post>
                    <div class="down">
                      <div class="row">
