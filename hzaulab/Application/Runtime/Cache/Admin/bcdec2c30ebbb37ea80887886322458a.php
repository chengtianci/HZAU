    ...
    <div class="modal-content">
      ...
      <div class="right_col" role="main">
        ...
        <div class="col-md-10 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>仪器设备申请<small>Lab Application</small></h2>
              <ul class="nav navbar-right panel_toolbox">
                <li class="panel_toolbox_li"><a class="close-link"><i class="fa fa-close"></i></a>
                </li>
                <li class="panel_toolbox_li"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
            ...
            <div class="x_content">
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php if(is_array($unchecked)): $i = 0; $__LIST__ = $unchecked;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($i); ?></td>
                      ...
                      <td><?php echo ($items["yjxm"]); ?></td>
                      <td><?php echo ($items["zycz"]); ?></td>
                      ...
                      <td>
                        <a href="/hzaulab/index.php/Admin/Equipment/doAgree/id/<?php echo ($items["id"]); ?>">同意 <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <!-- <a href="#" data-toggle="modal" data-target="#myModal3" >拒绝 <i class="fa fa-close"></i></a> -->
                        <a href="/hzaulab/index.php/Admin/Equipment/doReject/id/<?php echo ($items["id"]); ?>" >拒绝 <i class="fa fa-close"></i></a>
        ...
        <div class="col-md-10 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>仪器设备申请历史<small>Lab Application History</small></h2>
              <ul class="nav navbar-right panel_toolbox">
                <li class="panel_toolbox_li"><a class="close-link"><i class="fa fa-close"></i></a>
                </li>
                <li class="panel_toolbox_li"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
            ...
            <div class="x_content">
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php if(is_array($checkedhistory)): $i = 0; $__LIST__ = $checkedhistory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($i); ?></td>
                      <td><?php echo ($items["sslocation"]); ?></td>
                      <td><?php echo ($items["ssname"]); ?></td>
                      <td><?php echo ($items["yqid"]); ?></td>
              ...
              <br><br>
              <form action="/hzaulab/index.php/Admin/Equipment/doTheExport" method="post">
                <input type="text" name="value" value="仪器设备" hidden>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="form" action="/hzaulab/index.php/Admin/Equipment/" method="post" enctype="multipart/form-data">
                <b class="head">基本信息</b><br>
                <span class="eqthint">名称：</span><input type="text" class="gallery_eqt" name="ecname">
                <span class="eqthint">型号/单位：</span><input type="text" class="gallery_eqt" name=""><br>
                <span class="eqthint">生产商：</span><input type="text" class="gallery_eqt" name="ecmanufactor">
                <span class="eqthint">设备编号：</span><input type="text" class="gallery_eqt" name="eoutid"><br>
                <span class="eqthint">存放地：</span><input type="text" class="gallery_eqt" name="elocation">
                <span class="eqthint">设备总值：</span><input type="text" class="gallery_eqt" name="eprice"><br>
                <span class="eqthint">收费标准：</span><input type="text" class="gallery_eqt" name="gallery_title">
<!--                 <span class="eqthint">状态：</span>
                        <select class="gallery_eqt">
                          <option>故障</option>
