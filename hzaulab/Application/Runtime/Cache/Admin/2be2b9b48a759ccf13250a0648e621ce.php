              ...
              <table id="datatable" class="table table-striped table-bordered" style="text-align: center;">
                ...
                <tbody>
                  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($i); ?></td>
                      <td><a href="/hzaulab/index.php/Admin/Laboratory/labdis/id/<?php echo ($items["id"]); ?>"><?php echo ($items["ecname"]); ?></a></td>
                      <?php switch($items['eqclass']) { case 1: $hahaha = "公共实验室"; break; case 2: $hahaha = "教学实验室"; break; case 3: $hahaha = "实验辅助室"; break; } ?>
                      <td><?php echo ($hahaha); ?></td>
                      <td><?php echo ($items["eoutid"]); ?></td>
                      <td><?php echo ($items["now"]); ?></td>
                      <td>
                        <a href="/hzaulab/index.php/Admin/Laboratory/labdis/id/<?php echo ($items["id"]); ?>">修改 <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/hzaulab/index.php/Admin/Laboratory/deleteMe/id/<?php echo ($items["id"]); ?>" >删除 <i class="fa fa-close"></i></a>
                      </td>
              ...
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php if(is_array($unchecked)): $i = 0; $__LIST__ = $unchecked;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td>
                        <a href="/hzaulab/index.php/Admin/Laboratory/doAgree/id/<?php echo ($items["id"]); ?>">同意 <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <!-- <a href="#" data-toggle="modal" data-target="#myModal3" >拒绝 <i class="fa fa-close"></i></a> -->
                        <a href="/hzaulab/index.php/Admin/Laboratory/doReject/id/<?php echo ($items["id"]); ?>" >拒绝 <i class="fa fa-close"></i></a>
        ...
        <div class="col-md-10 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <br><br>
              <form action="/hzaulab/index.php/Admin/Laboratory/doTheExport" method="post">
                <input type="text" name="value" value="公共实验室" hidden>
      ...
      <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form class="form" action="/hzaulab/index.php/Admin/Laboratory/doAdd" method="post">
              <div class="modal-body">
                  <b class="head">基本信息</b><br>
                  <span class="eqthint">名称：</span><input type="text" class="gallery_eqt" name="gallery_title">
                  <span class="eqthint">分类：</span><select name="" id="">
