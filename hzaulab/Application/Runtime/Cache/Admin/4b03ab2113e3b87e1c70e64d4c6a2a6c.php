              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                              <td><?php echo ($i); ?></td>
                              <td><a href="/hzaulab/<?php echo ($vo["rsway"]); ?>"><?php echo ($vo["rsname"]); ?></a></td>
                              <td><?php echo ($vo["rsdate"]); ?></td>
                              <td>
                                  <a href="/hzaulab/index.php/Admin/Regulation/serviceDelete/id/<?php echo ($vo["id"]); ?>" >删除 <i class="fa fa-close"></i></a>
                              </td>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <form class="form" action="/hzaulab/index.php/Admin/Regulation/addOneRegulation" enctype="multipart/form-data" method="post">
